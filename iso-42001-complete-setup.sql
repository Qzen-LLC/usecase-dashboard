-- ================================================
-- COMPLETE ISO 42001 SETUP FOR SUPABASE
-- Includes both schema creation and data insertion
-- ================================================
...
SELECT 
    'Clauses' as entity_type,
    COUNT(*) as count
FROM "Iso42001Clause"
UNION ALL
SELECT 
    'Subclauses' as entity_type,
    COUNT(*) as count
FROM "Iso42001Subclause"
UNION ALL
SELECT 
    'Annex Categories' as entity_type,
    COUNT(*) as count
FROM "Iso42001AnnexCategory"
UNION ALL
SELECT 
    'Annex Items' as entity_type,
    COUNT(*) as count
