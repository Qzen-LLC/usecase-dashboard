-- ================================================
-- ISO 42001 SUBCLAUSES DATA INSERTION
-- Inserts subclauses 4.1–10.2 with questions and evidence examples
-- ================================================
...
INSERT INTO "Iso42001Subclause" (
  "id", "subclauseId", "title", "summary", "questions", "evidenceExamples", "orderIndex", "clauseId"
) VALUES
...
(gen_random_uuid()::TEXT, '4.1', 'Understanding the Organization and Its Context', 'Determine external and internal issues relevant to the organization''s purpose and its AIMS',
 ARRAY['What internal factors (culture, resources, knowledge) influence our AIMS?','What external factors (legal, ethical, market, social, technological) influence our AIMS?','How does our use/development of AI align with our business strategy?','What are our organization''s guiding principles or values related to AI?'],
...
(gen_random_uuid()::TEXT, '4.2', 'Understanding the Needs and Expectations of Interested Parties', 'Identify interested parties relevant to the AIMS and their requirements/expectations concerning AI',
 ARRAY['Who are the interested parties for our AI systems (customers, users, regulators, employees, public, partners)?','What are their relevant needs, expectations, and requirements (legal, ethical, contractual)?','How do we capture and review these requirements?'],
...
(gen_random_uuid()::TEXT, '4.3', 'Determining the Scope of the AI Management System', 'Define the boundaries and applicability of the AIMS within the organization',
 ARRAY['What organizational units, processes, and locations are included in the AIMS?','Which specific AI systems or applications are covered by the AIMS?','What stages of the AI lifecycle are included?','Are there any exclusions, and what is the justification?'],
...
(gen_random_uuid()::TEXT, '4.4', 'AI Management System', 'Establish, implement, maintain, and continually improve the AIMS in accordance with ISO 42001 requirements',
 ARRAY['Do we have the necessary processes and documentation established for the AIMS?','Are these processes being followed?','Are there mechanisms for maintaining and updating the AIMS?','Is there a process for continual improvement of the AIMS?'],
...
(gen_random_uuid()::TEXT, '5.1', 'Leadership and Commitment', 'Top management must demonstrate leadership by ensuring policy/objectives alignment, resource availability, integration, communication, and promoting improvement',
 ARRAY['How does top management show active involvement and support for the AIMS?','Are AIMS objectives aligned with strategic goals?','Are sufficient resources allocated?','Is the importance of AI governance communicated effectively?','How are ethical considerations promoted by leadership?'],
...
(gen_random_uuid()::TEXT, '5.2', 'Policy', 'Establish, communicate, and maintain an AI Policy appropriate to the organization''s context',
 ARRAY['Is there a documented AI Policy?','Does it include commitments to requirements and continual improvement?','Does it align with organizational AI principles/ethics?','Is it communicated and understood by relevant personnel?','Is it available to relevant interested parties?'],
...
(gen_random_uuid()::TEXT, '5.3', 'Organizational Roles, Responsibilities, and Authorities', 'Assign and communicate responsibilities and authorities for roles relevant to the AIMS',
 ARRAY['Who is ultimately accountable for the AIMS?','Who is responsible for specific AIMS tasks?','Are these roles, responsibilities, and authorities documented and communicated?','Are security roles and responsibilities defined in job descriptions?','Do staff know whom to contact for security or AI governance issues?'],
...
(gen_random_uuid()::TEXT, '6.1', 'Actions to Address Risks and Opportunities', 'Plan actions based on context, stakeholders, risks, and opportunities. Conduct AI risk assessments, plan risk treatments, and assess AI system impacts',
 ARRAY['Do we have a process for identifying risks and opportunities related to the AIMS?','Is there a defined AI risk assessment methodology?','Are risks related to AI systems systematically identified and assessed?','Do we update the risk register regularly?','Do we have treatment plans for significant risks?','Are chosen controls linked to risk priorities and documented?'],
...
(gen_random_uuid()::TEXT, '6.2', 'AI Objectives and Planning to Achieve Them', 'Establish measurable AIMS objectives aligned with the AI policy and plan how to achieve them',
 ARRAY['What are the specific, measurable objectives for our AIMS?','Are they consistent with the AI policy and organizational goals?','What actions, resources, responsibilities, and timelines are defined?','Are our information security objectives written down?','Are they reviewed and updated periodically?'],
...
(gen_random_uuid()::TEXT, '7.1', 'Resources', 'Determine and provide the resources needed for the AIMS',
 ARRAY['What resources (human, financial, technological, infrastructure) are needed?','Have these resources been identified and allocated?','Do we have sufficient resources allocated to ISMS tasks?','Are tools and infrastructure adequate for security requirements?'],
...
(gen_random_uuid()::TEXT, '7.2', 'Competence', 'Ensure personnel involved in the AIMS are competent based on education, training, or experience',
 ARRAY['What competencies are required for different AIMS roles?','How do we ensure individuals possess these competencies?','Are training needs identified and addressed?','Have we identified required competencies for security roles?','Do we offer relevant training or certifications?'],
...
(gen_random_uuid()::TEXT, '7.3', 'Awareness', 'Ensure relevant personnel are aware of the AI policy, their contribution, and the implications of non-conformance',
 ARRAY['Are staff aware of the AI Policy?','Do they understand how their work contributes to the AIMS and AI ethics?','Are they aware of the benefits of effective AI governance?','Have all employees received security awareness training?','Do they know how to report incidents?'],
...
(gen_random_uuid()::TEXT, '7.4', 'Communication', 'Determine and implement internal and external communications relevant to the AIMS',
 ARRAY['What needs to be communicated about the AIMS?','When, how, and with whom does communication occur?','Who is responsible for communication?','Do we have a communication plan for security messages?','Do we inform stakeholders about incidents promptly?'],
...
(gen_random_uuid()::TEXT, '7.5', 'Documented Information', 'Manage documented information required by the standard and necessary for AIMS effectiveness',
 ARRAY['What documentation is required by ISO 42001?','What other documentation do we need for our AIMS to be effective?','How do we ensure documents are properly identified, formatted, reviewed, approved, version controlled?','Do we version-control security documents?','Are sensitive records protected properly?'],
...
(gen_random_uuid()::TEXT, '8.1', 'Operational Planning and Control', 'Plan, implement, and control processes to meet requirements, implement actions from Clause 6, manage changes, and control outsourced processes',
 ARRAY['How are operational processes (related to AI development/deployment/use) planned and controlled?','How are changes to these processes or AI systems managed?','How do we control processes outsourced to third parties?','Do we have documented procedures for operational tasks?','Are controls applied consistently?'],
...
(gen_random_uuid()::TEXT, '8.2', 'AI Risk Assessment (Operational)', 'Perform AI risk assessments operationally (at planned intervals or upon significant changes)',
 ARRAY['How often are AI risk assessments reviewed and updated?','What triggers an ad-hoc risk assessment?','Do we assess risks for all major changes?','Are decisions documented based on updated risk findings?'],
...
(gen_random_uuid()::TEXT, '8.3', 'AI Risk Treatment (Operational)', 'Implement the AI risk treatment plan',
 ARRAY['Are the controls defined in the risk treatment plan actually implemented?','Is there evidence of control operation?','Do we track results of risk treatments?','Are failed treatments escalated quickly?'],
...
(gen_random_uuid()::TEXT, '9.1', 'Monitoring, Measurement, Analysis, and Evaluation', 'Determine what needs monitoring/measuring, the methods, frequency, and how results are analyzed/evaluated',
 ARRAY['What aspects of the AIMS and AI systems are monitored/measured?','What methods are used?','How often is data collected and analyzed?','Who analyzes/evaluates?','How are results used?','Do we have defined KPIs for security?','Are results reviewed periodically?'],
...
(gen_random_uuid()::TEXT, '9.2', 'Internal Audit', 'Conduct internal audits at planned intervals to ensure the AIMS conforms to requirements and is effectively implemented',
 ARRAY['Is there an audit program?','Are audits conducted by objective auditors?','Are criteria/scope defined?','Are results reported?','Are nonconformities addressed?','Is there a documented audit plan?','Are findings recorded and resolved promptly?'],
...
(gen_random_uuid()::TEXT, '9.3', 'Management Review', 'Top management must review the AIMS at planned intervals to ensure its continuing suitability, adequacy, and effectiveness',
 ARRAY['Are reviews conducted regularly?','Does review cover required inputs?','Are decisions made regarding improvements/changes?','Are minutes documented?','Are reviews held regularly with documented outputs?','Are improvement decisions tracked and implemented?'],
...
(gen_random_uuid()::TEXT, '10.1', 'Nonconformity and Corrective Action', 'React to nonconformities, evaluate need for action, implement corrective actions, review effectiveness, and update AIMS if needed',
 ARRAY['Is there a process for nonconformities?','How is correction handled?','Is root cause analysis performed?','How are corrective actions tracked and verified?','Are changes made to AIMS?','Do we track nonconformities in a register?','Are corrective actions tested and verified?'],
...
(gen_random_uuid()::TEXT, '10.2', 'Continual Improvement', 'Continually improve the suitability, adequacy, and effectiveness of the AIMS',
 ARRAY['How does the organization use results to drive improvement?','Is there evidence of ongoing efforts?','Do we have a process for suggesting and implementing improvements?','Are improvements reviewed by leadership?'],
