...
import { ChevronRight, ChevronLeft, Target, TrendingUp, Zap, DollarSign, Plus, Minus, Check, ChevronDown } from 'lucide-react';
      ...
      try {
        ...
        if (data) {
          setFormData(prev => ({
            ...
            businessFunction: Array.isArray(data.businessFunction) ? data.businessFunction : data.businessFunction ? [data.businessFunction] : [],
      ...
      <div className="space-y-8">
        ...
        <div className="bg-gray-75 dark:bg-gray-700 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <Label htmlFor="implementationComplexity" className='text-sm font-normal text-gray-800 dark:text-gray-200 mb-4'>How complex will this be to implement? (1 = Very Simple, 10 = Very Complex)</Label>
          </div>
        </div>
